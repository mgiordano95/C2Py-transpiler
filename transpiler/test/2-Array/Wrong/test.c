int main() {
    ...
    int myArray2[] = 24; //ArrayInit_Error_2 (Error: invalid initializer of 'myArray2')
    int myArray3[3] = 24; //ArrayInit_Error_3 (Error: invalid initializer of 'myArray3')
    
    //Assignment Error:
    array[] = {}; //ArrayAssign_Error_1 (Syntax Error)
    array[3] = {}; //ArrayAssign_Error_2 (Syntax Error)
    array[] = 24; //ArrayAssign_Error_3 (Error: element index not specified)
